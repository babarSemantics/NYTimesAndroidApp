...
import com.babar.nytimes.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    private fun viewNewsList() {
        ...
        viewModel.newsHeadLines.observe(viewLifecycleOwner,{response->
            when(response){
               is com.babar.nytimes.data.util.Resource.Success->{
                ...
                is com.babar.nytimes.data.util.Resource.Error->{
                   hideProgressBar()
                ...
                is com.babar.nytimes.data.util.Resource.Loading->{
                    showProgressBar()
                }
